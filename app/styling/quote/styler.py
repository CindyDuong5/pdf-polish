...
class QuoteStyler:
    """
    Rough quote restyler:
      - Stamps original quote PDF onto quote template PDF.
      - Does NOT parse fields yet.
      - Upgrade later without changing worker pipeline.
    """
